 ...
 * @Date: 2018/2/8 21:22
 */
public class GridListAdapter2 extends RecyclerView.Adapter<GridListAdapter2.GridViewHolder>{
    ...
    public GridListAdapter2(Context context, List<LatelyCity> data) {
